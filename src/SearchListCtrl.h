...
public:
	...
	//! Search kind label (e.g. "Local"/"Global"/"Kad") shown in the tab, kept in sync by CSearchDlg.
...
protected:
	...
	//! Search kind label (e.g. "Local"/"Global"/"Kad") for the tab, maintained by CSearchDlg.
