...
#ifndef UNIFIED_SEARCH_ENGINE_MANAGER_H
#define UNIFIED_SEARCH_ENGINE_MANAGER_H
 ...
 */
class UnifiedSearchEngineManager {
public:
    struct Config {
    ...
    explicit UnifiedSearchEngineManager(const Config& config);
    UnifiedSearchEngineManager();
    ~UnifiedSearchEngineManager();

    // Non-copyable, non-movable
    UnifiedSearchEngineManager(const UnifiedSearchEngineManager&) = delete;
    UnifiedSearchEngineManager& operator=(const UnifiedSearchEngineManager&) = delete;
    UnifiedSearchEngineManager(UnifiedSearchEngineManager&&) = delete;
    UnifiedSearchEngineManager& operator=(UnifiedSearchEngineManager&&) = delete;
