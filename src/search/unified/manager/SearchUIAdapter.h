...
/**
 * Adapter layer for integrating UnifiedSearchEngineManager with wxWidgets UI
...
private:
    /**
     * Handle wxCommandEvent from UnifiedSearchEngineManager
    ...
    class UnifiedSearchEngineManager* m_manager;
