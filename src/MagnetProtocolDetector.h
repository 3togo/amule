...
enum ProtocolPreference {
    ...
    PREFERENCE_BITTORRENT_ONLY,
    PREFERENCE_HYBRID_AUTO,
    PREFERENCE_HYBRID_ED2K_FIRST,
    PREFERENCE_HYBRID_BT_FIRST
};
...
public:
    ...
    /**
     * @brief Check if magnet URI contains BitTorrent hash  
     */
    bool HasBitTorrent() const;
    ...
    /**
     * @brief Get BitTorrent info hash if available
     */
    wxString GetBTHash() const;
