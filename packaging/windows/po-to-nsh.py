...
KEYS = [
    ...
    ("MYSTR_SEC_PROTO_ED2K",
        "Register aMule for ed2k:// links"),
    ("MYSTR_SEC_PROTO_MAGNET",
        "Register aMule for magnet: links"),
    ("MYSTR_SEC_ASSOC_COLLECTION",
        "Associate .emulecollection files"),
    ("MYSTR_SEC_UNINSTALL",
        "Uninstall"),
    ...
    ("MYSTR_DESC_PROTO_ED2K",
        "Makes aMule the default handler for ed2k:// links so clicking one in your browser or file manager opens it here."),
    ...
    ("MYSTR_DESC_ASSOC_COLLECTION",
        "Adds aMule to the \"Open with\" list for .emulecollection files, and makes it the default if no other program has claimed them. Opening a collection queues every eD2k link it contains."),
